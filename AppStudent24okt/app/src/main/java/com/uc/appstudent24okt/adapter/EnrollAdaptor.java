...
public class EnrollAdaptor extends RecyclerView.Adapter<EnrollAdaptor.CardViewViewHolder> {
    ...
    Lecturer lecturer;
    private CardViewViewHolder holder;
    ...
    public EnrollAdaptor(Context context) {
    ...
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_enroll_adaptor, parent, false);
        return new EnrollAdaptor.CardViewViewHolder(view);
    }


    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull final EnrollAdaptor.CardViewViewHolder holder, final int position) {
        this.holder = holder;
    ...
    class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        CardViewViewHolder(View itemView) {
            ...
            btn_enroll = itemView.findViewById(R.id.EnrollAdapterButton);
        }
    }
}
